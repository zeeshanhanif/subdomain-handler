...
module.exports = function(options){
	...
	return function(req, res, next){
		...
		if(req.url.indexOf(".css")>0 || req.url.indexOf(".js")>0 || req.url.indexOf(".html")>0 || req.url.indexOf(".jpg")>0
			|| req.url.indexOf(".png")>0 || req.url.indexOf(".svg")>0 || req.url.indexOf(".gif")>0
			|| req.url.indexOf(".woff")>0 || req.url.indexOf(".ttf")>0 ){
			return next();
        }
